...
plt.title("Histogram of present value of payoffs in Ordinary MC Method")
plt.xlabel("Bins")
...
plt.title("Accuracy of Estimation in Ordinary MC")
plt.show()

# final_prices = [i[-1] for i in price_paths]
# plt.hist(final_prices, 200)
# plt.title("Histogram of final prices of asset in Ordinary MC Method")
# plt.show()
